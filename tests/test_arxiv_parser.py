...
class TestOldFormatParsing:
    ...
    def test_1990s_paper(self):
        ...
        assert parsed.internal_id == "199901_00001"
    ...
    def test_2000s_paper(self):
        ...
        assert parsed.internal_id == "200703_00001"
    ...
    def test_math_paper(self):
        ...
        assert parsed.internal_id == "200309_00136"
    ...
    def test_4digit_sequence(self):
        ...
        assert parsed.internal_id == "199901_01234"
    ...
    def test_december_paper(self):
        ...
        assert parsed.internal_id == "199912_00999"
...
class TestFormatTransition:
    ...
    def test_march_2007_old_format(self):
        ...
        assert parsed.internal_id == "200703_00999"
        assert parsed.is_old_format is True
...
class TestTemporalOrdering:
    ...
    def test_chronological_ordering(self):
        """Test that IDs sort chronologically."""
        ids = [
        ...
        internal_ids = [p.internal_id for p in parsed]

        # Check that internal IDs are in ascending order
        assert internal_ids == sorted(internal_ids)

    def test_same_month_ordering(self):
        """Test ordering within same month."""
    ...
    def test_validate_temporal_ordering_function(self):
        ...
        parsed_ids = [
            ArxivIdParser.parse("hep-ph/9901001"),
    ...
    def test_validate_temporal_ordering_works_any_input_order(self):
        ...
        # Create IDs from different times
        id1 = ParsedArxivId(
            original_id="test1",
            internal_id="202301_00001",
            year=2023,
            month=1,
            sequence=1,
            archive=None,
...
class TestConvenienceFunction:
    ...
    def test_old_format(self):
        ...
        assert normalize_arxiv_id("hep-ph/9901001") == "199901_00001"
...
class TestEdgeCases:
    ...
    def test_january_papers(self):
        ...
        parsed = ArxivIdParser.parse("hep-ph/9901001")
        assert parsed.month == 1
        assert "01_" in parsed.internal_id
...
class TestInternalIdFormat:
    ...
    def test_id_length(self):
        """Test internal ID has correct length."""
        ids = [
            "hep-ph/9901001",
            "0704.0001",
            "2301.12345",
        ...
        for arxiv_id in ids:
            parsed = ArxivIdParser.parse(arxiv_id)
            # Format: YYYYMM_SSSSS = 6 + 1 + 5 = 12 characters
            assert len(parsed.internal_id) == 12
